...
class RecipeHelper {
  static List<Recipe> featuredRecipe = featuredRecipeRawData
      .map((data) => Recipe(
            ...
            reviews:
                Review.toList(data['reviews'] as List<Map<String, String>>),
            tutorial: TutorialStep.toList(
                data['tutorial'] as List<Map<String, String>>),
            ingridients: Ingridient.toList(
                data['ingridients'] as List<Map<String, String>>),
          ))
      .toList();
  ...
  static Recipe popularRecipe = Recipe(
    ...
    reviews: Review.toList(
        popularRecipeRawData['reviews'] as List<Map<String, String>>),
    tutorial: TutorialStep.toList(
        popularRecipeRawData['tutorial'] as List<Map<String, String>>),
    ingridients: Ingridient.toList(
        popularRecipeRawData['ingridients'] as List<Map<String, String>>),
  );
